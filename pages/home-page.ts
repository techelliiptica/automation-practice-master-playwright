...
export class HomePage extends BasePage {
  ...
  readonly formSubmissionCard: Locator;
  readonly buttonInteractionsCard: Locator;
  readonly dropdownSelectCard: Locator;
  readonly checkboxRadioCard: Locator;
  readonly dynamicContentCard: Locator;
  readonly alertsModalsCard: Locator;
  readonly tableDataCard: Locator;
  readonly fileUploadCard: Locator;
  readonly hoverTooltipCard: Locator;
  readonly dragDropCard: Locator;
  readonly iframeCard: Locator;
  readonly datePickerCard: Locator;
  readonly linkInteractionsCard: Locator;
  readonly imageInteractionsCard: Locator;
  readonly superAssignmentCard: Locator;
  ...
  async clickScenarioCard(scenarioName: string) {
